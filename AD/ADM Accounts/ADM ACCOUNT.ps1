...
$newADM =  Get-ADUser -Filter "GivenName -eq '$FirstName' -and Surname -eq '$LastName'" -Properties EmailAddress -Server AMRNDSVPDC03 | select -First 1
$TemplateAcct = Read-Host 'Template Account'
...
I've created you a new ADM account for you.
