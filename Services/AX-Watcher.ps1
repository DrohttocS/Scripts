...
$CurrentStatus = $CurrentStatus | Select-Object -ExpandProperty ReplacementStrings
...
$server = hostname
 ...
 #############################    EMAIL Loop   ################################
       ...
       $To = "krushah@synoptek.com","jim.fitch@nidec-motor.com","janet.kurowski@nidec-motor.com"
