...
###################################
  ...
  Foreach ($SF in $evt_SF){Write-Host $SF 
  ...
  Foreach ($S in $evt_S){Write-Host $SF 
...
** This message came from an EXTERNAL source. Please be careful with links and attachments. ** 
